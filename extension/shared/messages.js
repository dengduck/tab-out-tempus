...
export const MSG = Object.freeze({
  ...
  REQ_SET_THEME:          'REQ_SET_THEME',
  REQ_SET_RETENTION:      'REQ_SET_RETENTION',
  REQ_SET_FOCUS_HOSTS:    'REQ_SET_FOCUS_HOSTS',
  REQ_SET_GROUP_MODE:     'REQ_SET_GROUP_MODE',
  REQ_UPSERT_CATEGORY:    'REQ_UPSERT_CATEGORY',
  REQ_REMOVE_CATEGORY:    'REQ_REMOVE_CATEGORY',
  REQ_SET_DOMAIN_CATEGORY:'REQ_SET_DOMAIN_CATEGORY',
  REQ_SET_DOMAIN_BUDGET:  'REQ_SET_DOMAIN_BUDGET',
  REQ_SET_DOMAIN_RULE:    'REQ_SET_DOMAIN_RULE',
  REQ_UPSERT_CUSTOM_GROUP:'REQ_UPSERT_CUSTOM_GROUP',
  REQ_REMOVE_CUSTOM_GROUP:'REQ_REMOVE_CUSTOM_GROUP',
  REQ_EXPORT_HISTORY:     'REQ_EXPORT_HISTORY',
  REQ_CLEAR_HISTORY:      'REQ_CLEAR_HISTORY',
  REQ_FOCUS_GUARD_RETURN:'REQ_FOCUS_GUARD_RETURN',
  REQ_FOCUS_GUARD_STOP:  'REQ_FOCUS_GUARD_STOP',
  REQ_FOCUS_GUARD_ALLOW: 'REQ_FOCUS_GUARD_ALLOW',

  // 旧 UI 生命周期兼容入口；新版本使用 runtime Port。
  REQ_UI_READY:           'REQ_UI_READY',
  REQ_UI_GONE:            'REQ_UI_GONE',

  // ===== 订阅式 BCAST_* =====
  BCAST_TICK:         'BCAST_TICK',           // {now,todayMs,activeTabId,isActive,tabTimes,domainTimes}
  BCAST_TAB_CHANGE:   'BCAST_TAB_CHANGE',     // {action: 'added'|'removed'|'updated'|'moved', tabInfo}
  BCAST_STATE_CHANGE: 'BCAST_STATE_CHANGE',   // partial {pauseReasons, tracking, privateMode, focusTimer}
  BCAST_CONFIG_CHANGE:'BCAST_CONFIG_CHANGE',  // {config}
  BCAST_SAVED_CHANGE: 'BCAST_SAVED_CHANGE',   // {saved}
});
